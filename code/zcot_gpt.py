...
logging.basicConfig(
    ...
    datefmt='%Y-%m-%d %H:%M:%S',
    handlers=[
        logging.FileHandler("/data/stance_detection_project/stance_detection_project/runcot_gpt.log", encoding='utf-8')  # 运行日志自动保存到 run.log
    ]
)
...
INPUT_EXCEL_PATH = "/data/stance_detection_project/stance_detection_project/data/testgpt.xlsx"
OUTPUT_JSON_PATH = "/data/stance_detection_project/stance_detection_project/results/test_predictions_real_zcot_gpt_test.json"
