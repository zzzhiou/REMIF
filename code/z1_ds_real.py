...
logging.basicConfig(
    ...
    datefmt='%Y-%m-%d %H:%M:%S',
    handlers=[
        logging.FileHandler("/data/stance_detection_project/stance_detection_project/run_ds_real.log", encoding='utf-8')  # 运行日志自动保存到 run.log
    ]
)
logger = logging.getLogger(__name__)

# ===================== 核心配置（仅修改API_KEY） =====================
API_KEY = "sk-da3862"  # 填入你的真实API Key
...
OUTPUT_JSON_PATH = "/data/stance_detection_project/stance_detection_project/results/test_predictions_real_z1_ds_real.json"
