...
logging.basicConfig(
    ...
    datefmt='%Y-%m-%d %H:%M:%S',
    handlers=[
        logging.FileHandler("/data/stance_detection_project/stance_detection_project/run.log", encoding='utf-8')  # 运行日志自动保存到 run.log
    ]
)
logger = logging.getLogger(__name__)

# ===================== 核心配置（仅修改API_KEY） =====================
API_KEY = "sk-da3862f95da94483b8e8ca"  # 填入你的真实API Key
